...
- 实验计划：`dual_shift_ds042/docs/DS-042_MULTIMODAL_UDA_EXPERIMENT_PLAN_2026-08-29.md`
- 研究主地图：`dual_shift_ds042/docs/DUALSHIFT_MULTIMODAL_UDA_MASTER_MAP_2026-08-29.md`
- 运行日志：`ds042_runs/seed42_gpu0.log`、`seed43_gpu1.log`、`seed44_gpu2.log`
- 指标文件：`ds042_runs/ADNI_to_NACC/seed_42/`、`seed_43/`、`seed_44/` 下各变体的 `journal_metrics.json`
- split/provenance：各 seed 目录下的 `split_manifest.json`、`metadata_match_audit.json`。
