...
- 汇总指标：[outputs/DS-043_SUMMARY_METRICS.json](../../../outputs/DS-043_SUMMARY_METRICS.json)
- 每个运行的 `report.json`、`predictions.json` 和 checkpoint 保留在服务器端运行目录，不纳入 Git。
- 实验计划：[DS-043_CAPM_MULTIMODAL_CONCAT_EXPERIMENT_PLAN_2026-09-02.md](../../DS-043_CAPM_MULTIMODAL_CONCAT_EXPERIMENT_PLAN_2026-09-02.md)
